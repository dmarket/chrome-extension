...
- `pnpm dlx storybook@latest automigrate --config-dir libs/mythical-games/ui-explorer/storybook/.storybook`

- `pnpm dlx storybook@latest automigrate --config-dir libs/mythos-foundation/ui-explorer/storybook/.storybook`
